...
df <- read_csv("~/Documents/Labwork/Joe/Positional-Information/wiki_entropy/als_df.csv")
...
als_slopes <- get_wiki_slopes(min_length = 6, max_length = 50, utterances=df, REPS)
```
