...
label_data <- data_frame(length = 8, language = "Spanish", gram_order = 6,
                         speaker_role = c("Adult", "Child"), empirical_entropy = c(9,10.25))

df %>% 
  filter(language %in% c("English", "Mandarin", "Spanish"), gram == "bigram", length %in% c(4, 6, 8)) %>%
