...
In Yu et al. (2016), the authors challenge the UID perspective through computing the unigram positional entropy within the text portion of the British National Corpus (BNC). We follow Yu et al. (2016) in using the following formula for each word position X of sentences of fixed length k from the corpus, where each $w$ is a word occurring in position $X$ and $p(w)$ is the number of times word $w$ occurs in position X divided by the number of total words that occur in position $X$ i.e. the number of sentences of length $k$.
